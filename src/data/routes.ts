...
export const routes: RouteItem[] = [
  {
    ...
    itinerary: [
      ...
      { time: '15:00', title: '雪景公路 / 田野补景', detail: '返程途中可按天气停靠雪原、树林或服务区拍照，补充北海道冬日氛围感。', image: '/images/asahiyama/snow-road-hd-01.jpg' },
  ...
  },
  {
    ...
    image: '/images/biei-blue-pond_mafengwo_04.png',
    duration: '1 Day',
    ...
    itinerary: [
      ...
      { time: '10:30', title: '青池 & 白须瀑布', detail: '冬季可看雪覆蓝池与结冰溪谷，夏季是经典蓝绿色水景，全年都很上镜。', image: '/images/biei-blue-pond_mafengwo_04.png' },
      { time: '14:00', title: '拼布之路 / 四季彩之丘', detail: '根据季节改走丘陵、花田、孤独的树或雪地活动点，兼顾轻松与出片率。', image: '/images/biei-patchwork_mafengwo_03.png' },
  ...
  {
    slug: 'otaru-day-tour',
    image: '/images/otaru-canal_mafengwo_04.png',
    duration: '1 Day',
    ...
    itinerary: [
      ...
      { time: '10:30', title: '小樽运河散策', detail: '漫步石仓群、运河边步道与港口街景，冬季尤其有电影感。', image: '/images/otaru-canal_mafengwo_04.png' },
      { time: '14:00', title: '堺町通自由活动', detail: '逛玻璃工艺、音乐盒堂、伴手礼商店，也可加走天狗山看海港高处视角。', image: '/images/otaru-sakaimachi_mafengwo_03.png' },
  ...
  },
  {
    ...
    image: '/images/toya-lake_mafengwo_04.png',
    duration: '1 Day',
    ...
    itinerary: [
      ...
      { time: '14:00', title: '登别温泉街 / 地狱谷轻徒步', detail: '下午转往登别，保留地狱谷作为补充看点，以温泉街散策和火山地貌短停为主。', image: '/images/noboribetsu-jigokudani_mafengwo_04.png' },
      { time: '15:30', title: '昭和新山 / 熊牧场可选', detail: '若时间充裕，可增加昭和新山、熊牧场或有珠山缆车等机动景点，让行程更灵活。', image: '/images/noboribetsu-toya/lake-toya/01.jpg' },
      { time: '18:30', title: '返回札幌', detail: '适合作为冬季北海道里兼顾玩雪、看湖景与温泉氛围的一条成熟一日线路。' },
    ],
    title: {
      zh: '登别洞爷雪地摩托一日游',
  ...
  },
  {
    ...
    image: '/images/east-kussharo-swans_mafengwo_04.png',
    ...
    itinerary: [
      ...
      { time: 'D2', title: '阿寒湖 / 屈斜路湖', detail: '看湖景、温泉与冬季天鹅等季节性风物，节奏相对舒缓。', image: '/images/east-kussharo-swans_mafengwo_04.png' },
      { time: 'D3', title: '摩周湖 & 硫黄山', detail: '高能见度时安排经典观景点，也可增加硫黄山与周边地热地貌。', image: '/images/east-mashu_mafengwo_04.png' },
      { time: 'D4', title: '知床 / 网走方向', detail: '根据季节安排知床五湖、流冰破冰船、鄂霍次克海沿线或野生动物观察。', image: '/images/east-shiretoko_mafengwo_04.png' },
      { time: 'D5', title: '鹤居村 / 钏路湿原', detail: '冬季重点看丹顶鹤，其他季节可走湿原展望与生态摄影路线。', image: '/images/east-crane_mafengwo_04.png' },
