...
export const routes: RouteItem[] = [
  {
    ...
    image: '/images/asahiyama/penguin-walk/01.jpg',
    duration: '1 Day',
    ...
    itinerary: [
      { time: '08:00', title: '札幌市区出发', detail: '酒店或民宿上门接送，走道央高速北上，冬季全程包车更省心。', image: '/images/asahiyama/penguin-walk/01.jpg' },
      { time: '10:30', title: '旭山动物园核心参观', detail: '重点观看企鹅散步、北极熊馆、海豹馆与企鹅馆，适合亲子和第一次来北海道的客人。', image: '/images/asahiyama/polar-bear/01.jpg' },
      { time: '15:00', title: '雪景公路 / 田野补景', detail: '返程途中可按天气停靠雪原、树林或服务区拍照，补充北海道冬日氛围感。', image: '/images/asahiyama/seal/01.jpg' },
      { time: '18:00', title: '返回札幌', detail: '送回酒店，适合作为北海道亲子行程中的轻松一日安排。', image: '/images/asahiyama/penguin-walk/01.jpg' },
    ],
    title: {
      zh: '旭山动物园一日游',
      ja: '旭山動物園 日帰りツアー',
  ...
  },
  {
    ...
    image: '/images/biei-furano/blue-pond/01.jpg',
    duration: '1 Day',
    ...
    itinerary: [
      { time: '08:00', title: '札幌出发', detail: '包车前往美瑛富良野方向，车程较长但路线成熟，适合全天拍照打卡。', image: '/images/biei-furano/blue-pond/01.jpg' },
      { time: '10:30', title: '青池 & 白须瀑布', detail: '冬季可看雪覆蓝池与结冰溪谷，夏季是经典蓝绿色水景，全年都很上镜。', image: '/images/biei-furano/shirahige-falls/01.jpg' },
      { time: '14:00', title: '拼布之路 / 四季彩之丘', detail: '根据季节改走丘陵、花田、孤独的树或雪地活动点，兼顾轻松与出片率。', image: '/images/biei-furano/patchwork-road/01.jpg' },
      { time: '17:30', title: '返回札幌', detail: '日落前后返程，冬季沿途雪原和林道也很适合补拍风景。', image: '/images/biei-furano/shikisai-hill/01.jpg' },
    ],
    title: {
      zh: '美瑛富良野一日游',
      ja: '美瑛・富良野 日帰りツアー',
  ...
  {
    slug: 'otaru-day-tour',
    image: '/images/otaru/canal/01.jpg',
    duration: '1 Day',
    ...
    itinerary: [
      { time: '09:00', title: '札幌出发', detail: '约 1 小时抵达小樽，适合作为轻松不折腾的一日游或半日延长线。', image: '/images/otaru/canal/01.jpg' },
  ...
  },
  {
    ...
    image: '/images/noboribetsu-toya/lake-toya/01.jpg',
    duration: '1 Day',
    ...
    itinerary: [
      { time: '08:00', title: '札幌出发', detail: '沿道央高速南下，包车可减少换乘并更灵活控制停留时间。', image: '/images/noboribetsu-toya/lake-toya/01.jpg' },
      ...
      { time: '14:00', title: '登别温泉街 / 地狱谷轻徒步', detail: '下午转往登别，保留地狱谷作为补充看点，以温泉街散策和火山地貌短停为主。', image: '/images/noboribetsu-toya/jigokudani/01.jpg' },
      { time: '15:30', title: '昭和新山 / 熊牧场可选', detail: '若时间充裕，可增加昭和新山、熊牧场或有珠山缆车等机动景点，让行程更灵活。', image: '/images/noboribetsu-toya/onsen-street/01.jpg' },
      { time: '18:30', title: '返回札幌', detail: '适合作为冬季北海道里兼顾玩雪、看湖景与温泉氛围的一条成熟一日线路。', image: '/images/noboribetsu-toya/lake-toya/01.jpg' },
    ],
    title: {
      zh: '登别洞爷雪地摩托一日游',
  ...
  },
  {
    ...
    image: '/images/east-hokkaido/kussharo-swans/01.jpg',
    ...
    itinerary: [
      { time: 'D1', title: '札幌 / 新千岁集合', detail: '接机后出发前往道东方向，按航班与季节安排首晚住宿。', image: '/images/east-hokkaido/kussharo-swans/01.jpg' },
      ...
      { time: 'D4', title: '知床 / 网走方向', detail: '根据季节安排知床五湖、流冰破冰船、鄂霍次克海沿线或野生动物观察。', image: '/images/east-hokkaido/shiretoko-five-lakes/01.jpg' },
      { time: 'D5', title: '鹤居村 / 钏路湿原', detail: '冬季重点看丹顶鹤，其他季节可走湿原展望与生态摄影路线。', image: '/images/east-hokkaido/red-crowned-crane/01.jpg' },
      { time: 'D6', title: '返程日', detail: '根据回程城市安排送机或回札幌，可做最后的湖景或湿原补拍。', image: '/images/east-hokkaido/abashiri-icebreaker/01.jpg' },
    ],
    title: {
      zh: '道东6天5晚深度游',
      ja: '道東 6日5泊ディープツアー',
