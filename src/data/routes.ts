...
export const routes: RouteItem[] = [
  ...
  },
  {
    ...
    image: '/images/biei-furano/blue-pond-winter/01.jpg',
    duration: '1 Day',
    ...
    itinerary: [
      { time: '08:00', title: '札幌出发', detail: '包车前往美瑛富良野方向，车程较长但路线成熟，适合全天拍照打卡。', image: '/images/biei-furano/patchwork-road/01.jpg' },
  ...
  },
  {
    ...
    itinerary: [
      { time: '09:00', title: '札幌出发', detail: '约 1 小时抵达小樽，适合作为轻松不折腾的一日游或半日延长线。', image: '/images/otaru/snow-street/01.jpg' },
  ...
  },
  {
    ...
    image: '/images/noboribetsu-toya/snowmobile/01.jpg',
    duration: '1 Day',
